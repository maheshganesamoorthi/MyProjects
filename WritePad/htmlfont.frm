VERSION 5.00
Begin VB.Form htmlfont 
   Caption         =   "Font"
   ClientHeight    =   3615
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   4740
   Icon            =   "htmlfont.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3615
   ...
   End
End
Attribute VB_Name = "htmlfont"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
frmMain1.RTBox.SelText = "<FONT" + " " + "FACE=" + Text1.Text + Combo1.Text + Text1.Text + "  " + "SIZE=" + Text1.Text + Combo2.Text + Text1.Text + " " + "COLOR=" + Text1.Text + Right(Combo3.Text, 7) + Text1.Text + ">" + "  " + "</FONT>"
Unload Me
End Sub
