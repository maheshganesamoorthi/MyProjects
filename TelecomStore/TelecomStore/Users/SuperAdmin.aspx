<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuperAdmin.aspx.cs" Inherits="TelecomStore.Users.SuperAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="menu1">
				<ul>
					...
					<li id="menu-02"><asp:HyperLink ID="viewuser" Text="View/Delete/Update User" runat="server" NavigateUrl="~/Users/ViewUser.aspx" /></li>
