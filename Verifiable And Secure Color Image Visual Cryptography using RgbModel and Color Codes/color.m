...
% COLOR M-file for color.fig
%      COLOR, by itself, creates a color COLOR or raises the existing
%      singleton*.
%
%      H = COLOR returns the handle to a color COLOR or the handle to
...
%
%      COLOR('Property','Value',...) creates a color COLOR or raises the
...
% Last Modified by GUIDE v2.5 05-Dec-2011 14:51:35
