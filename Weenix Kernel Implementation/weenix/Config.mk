...
# (the grader will use the next line for grading "self-checks" and section (A) of grading guidelines)
#       DBG = error,temp,print,test,testpass,testfail
# (the grader will use the next line when grading in general, i.e., will not see things printed with DBG_PRINT)
#       DBG = error,temp,test,testpass,testfail
