...
int faber_space_test(kshell_t *ksh, int argc, char **argv) {
	...
	kprintf(ksh, ">>> Running faber_space_test()... ");
	/* Create the file */
 ...
 * (where n is arg1) and writes 20 files into it called /dir00n/test000 through
...
/* 
 * A function executed by a thread that creates a directory called /dir00n
 * (where n is arg1) and unlinks 20 files from it called /dir00n/test000 through
